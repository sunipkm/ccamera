/**
 * @file CameraUnit_AndorUSB.cpp
 * @author Sunip K. Mukherjee (sunipkmukherjee@gmail.com)
 * @brief CameraUnit wrapper for Andor USB cameras (Windows)
 * @version 0.1
 * @date 2022-06-29
 * 
...
#ifndef OS_Windows
#error "Compilation can not proceed, intended for Windows only."
#else
...
{
    std::unique_lock<std::mutex> lock(criticalSection_);
    CImageData retVal;
